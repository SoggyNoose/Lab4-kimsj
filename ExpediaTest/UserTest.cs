...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveCarFromServiceLocatorWhenBooked()
        {
            ...
            var carToBook = ObjectMother.Saab();
            var remainingCar = ObjectMother.BMW();
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(10), new DateTime(15), 30);
            var remainingFlight = new Flight(new DateTime(11), new DateTime(12), 12657);
            serviceLocator.AddFlight(flightToBook);
            serviceLocator.AddFlight(remainingFlight);

            typeof (ServiceLocator).GetField("_instance", BindingFlags.Static | BindingFlags.NonPublic).SetValue(
